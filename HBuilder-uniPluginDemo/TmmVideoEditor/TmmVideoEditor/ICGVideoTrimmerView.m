...
//    _themeColor = [UIColor lightGrayColor];
    _themeColor = [UIColor colorWithRed:255.0/255.0 green:204.0/255.0 blue:1.0/255.0 alpha:1];
...
- (instancetype)initWithFrame:(CGRect)frame asset:(AVAsset *)asset
{
    ...
    if (self) {
        _asset = asset;
        _themeColor = [UIColor colorWithRed:7/255.0 green:193/255.0 blue:96/255.0 alpha:1];
//        _themeColor = [UIColor colorWithRed:255.0/255.0 green:204.0/255.0 blue:1.0/255.0 alpha:1];
//        [self resetSubviews];
    }
    return self;
...
{
    return _rulerLabelInterval ?: 40;
}

#define EDGE_EXTENSION_FOR_THUMB 30
- (void)resetSubviews
{
    UIColor * bgColor = [UIColor colorWithRed:56.0/255.0 green:56.0/255.0 blue:56.0/255.0 alpha:1];
    CALayer *sideMaskingLayer = [CALayer new];
    sideMaskingLayer.backgroundColor = bgColor.CGColor;
    ...
    self.trackerView.layer.cornerRadius = 8.f;
...
//    [self.leftOverlayView setBackgroundColor:[UIColor colorWithWhite:0 alpha:0.8]];
    ...
    NSLog(@"开始渲染底部控制条, delegate => %@", self.delegate);
